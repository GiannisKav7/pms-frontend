...
export const propertyFieldConfig: Record<string, FieldConfig> = {
...
const PropertyDetails: React.FC = () => {
  ...
  const [form] = Form.useForm<PropertyDetailsType>();
  const [details, setDetails] = useState<PropertyDetailsType>(initialDetails);
    ...
    taxInfo: [
      {
        ...
        render: (text: string) => (
          <a style={{ color: "#1890ff" }} onClick={() => handleNavigation(text, "legalEntity")}>
            {text}
          </a>
        ),
      },
      ...
      { title: "Tax Point", dataIndex: "taxPoint", key: "taxPoint" },
      {
        ...
        render: (text: string) => (
          <a style={{ color: "#1890ff" }} onClick={() => handleNavigation(text, "reportEntity")}>
            {text}
          </a>
        ),
      },
