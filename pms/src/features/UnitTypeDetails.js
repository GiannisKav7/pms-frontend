      ...
      <Row gutter={16} style={{ marginTop: 24 }}>
        ...
        <Col span={12}>
          <Card title="Rent Information" bordered>
            <p><b>Rent:</b> {details.rent}</p>
            <p><b>Minimum Rent:</b> {details.minimumRent}</p>
            <p><b>Maximum Rent:</b> {details.maximumRent}</p>
            <p><b>Deposit:</b> {details.deposit}</p>
          </Card>
          <Card title="Features & Options" bordered style={{ marginTop: 16 }}>
            <p><b>Features:</b> {details.features}</p>
            <p><b>Options:</b> {details.options}</p>
          </Card>
        </Col>
      </Row>
    </div>
