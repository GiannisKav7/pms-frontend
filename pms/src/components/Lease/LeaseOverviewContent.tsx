...
const LeaseOverviewContent: React.FC<LeaseOverviewContentProps> = ({
  leaseDetails,
}) => {
      ...
      <Card title="Lease Overview" className={styles.card}>
        <div className={styles.grid}>
          ...
          <FormGroup className={styles.groupTitle} title="Rent Info">
            <NumberWithPostfix
              label="Rent Yearly"
              value={leaseDetails.rentYearly}
              postfix="€"
              readOnly
            />
            <NumberWithPostfix
              label="Rent Per Sqm Monthly"
              value={leaseDetails.rentPerSqmMonthly}
              postfix="€/sqm"
              readOnly
            />
            <NumberWithPostfix
              label="Rent Per Sqm Yearly"
              value={leaseDetails.rentPerSqmYearly}
              postfix="€/sqm"
              readOnly
            />
          </FormGroup>
          <FormGroup className={styles.groupTitle} title="Key Dates">
            ...
            <Input
              label="Move Out Date"
              value={leaseDetails.moveOutDate}
              readOnly
            />
            <Input
              label="Last Renewal Date"
              value={leaseDetails.lastRenewalDate}
              readOnly
            />
            ...
            <Input
              ...
              value={leaseDetails.nextRentReviewDate}
              readOnly
            />
          </FormGroup>
          <FormGroup className={styles.groupTitle} title="Security/Deposits">
            ...
            <NumberWithPostfix
              ...
              value={leaseDetails.depositsRequired}
              postfix="€"
              readOnly
            />
            <NumberWithPostfix
              label="Deposits Billed"
              value={leaseDetails.depositsBilled}
              postfix="€"
              readOnly
            />
            <NumberWithPostfix
              label="Deposits Received"
              value={leaseDetails.depositsReceived}
              postfix="€"
              readOnly
            />
          </FormGroup>
