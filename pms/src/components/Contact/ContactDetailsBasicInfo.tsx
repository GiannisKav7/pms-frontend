...
interface ContactDetailsBasicInfoProps {
  form: FormInstance;
  details: Record<string, any>;
  isEditing: boolean;
  handleNavigation: (value: string, key: string) => void;
  contactFieldConfig: Record<string, any>;
}

const ContactDetailsBasicInfo: React.FC<ContactDetailsBasicInfoProps> = ({
  form,
  details,
  isEditing,
  handleNavigation,
...
export default ContactDetailsBasicInfo;