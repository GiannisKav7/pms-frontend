...
interface FloorDetailsBasicInfoProps {
  form: any;
  details: Record<string, any>;
  isEditing: boolean;
  handleNavigation: (value: string, type: string) => void;
  floorFieldConfig: Record<string, any>;
}

const FloorDetailsBasicInfo: React.FC<FloorDetailsBasicInfoProps> = ({ form, details, isEditing, handleNavigation, floorFieldConfig }) => (
...
export default FloorDetailsBasicInfo;